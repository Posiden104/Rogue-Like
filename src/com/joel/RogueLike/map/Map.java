...
public class Map {
	...
	public Map() {
		...
		map[0][1] = new Tile(TileSet.stoneFloor.getTile(1, 0), 0, 1);
		map[0][2] = new Tile(TileSet.stoneFloor.getTile(1, 0), 0, 2);
		map[0][3] = new Tile(TileSet.stoneFloor.getTile(1, 0), 0, 3);
		map[0][4] = new Tile(TileSet.stoneFloor.getTile(2, 0), 0, 4);
